...
// Only Yollama supported types are considered valid
...
const (
	...
	TensorTypeQ6_K
	TensorTypeQ8_K
	tensorTypeIQ2_XXS // not supported by yollama
	tensorTypeIQ2_XS  // not supported by yollama
	tensorTypeIQ3_XXS // not supported by yollama
	tensorTypeIQ1_S   // not supported by yollama
	tensorTypeIQ4_NL  // not supported by yollama
	tensorTypeIQ3_S   // not supported by yollama
	tensorTypeIQ2_S   // not supported by yollama
	tensorTypeIQ4_XS  // not supported by yollama
	TensorTypeI8
	TensorTypeI16
	TensorTypeI32
	TensorTypeI64
	TensorTypeF64
	tensorTypeIQ1_M // not supported by yollama
	TensorTypeBF16
	tensorTypeQ4_0_4_4   // unused by GGML
	tensorTypeQ4_0_4_8   // unused by GGML
	tensorTypeQ4_0_8_8   // unused by GGML
	tensorTypeTQ1_0      // not supported by yollama
	tensorTypeTQ2_0      // not supported by yollama
