...
import (
	...
	"github.com/EnlistedGhost/Yollama/internal/modelref"
	"github.com/EnlistedGhost/Yollama/parser"
	"github.com/EnlistedGhost/Yollama/progress"
	"github.com/EnlistedGhost/Yollama/server"
	"github.com/EnlistedGhost/Yollama/types/model"
	"github.com/EnlistedGhost/Yollama/types/syncmap"
...
func handlePullUnAuthorizedError(err error) bool {
	return false
}

func ensureRemotePullStub(ctx context.Context, client *api.Client, modelName string) {
...
func RunHandler(cmd *cobra.Command, args []string) error {
	...
	// TODO: Remove after verifying level of importance
	ensureRemotePullStub(cmd.Context(), client, name)
